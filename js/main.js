...
function addResources(contents) {
    ...
    for (let resource in contents) {
        // Replace image texts
        if (contents[resource].image === "" || contents[resource].image === "blank") contents[resource].image = "images/system/air.png";
...
function setUpGrinds() {
    ...
    for (let i = 0; i < areaGrinds.length; i++) {
        ...
        imgEl.src = "images/system/air.png";
        toolImgEl.className = "grind-tool-image";
        toolImgEl.src = "images/system/air.png";
...
function showGrindResources(e, grind) {
    ...
    for (let resource of resources) {
        ...
        // Else if there is no tool
            ...
            toolImage = "images/system/air.png";
        }
...
function finishGrind(playerGrind, grind) {
    ...
    if (grind) {
        ...
        grind.children[2].children[0].children[0].src = "images/system/air.png";

        grind.children[1].style.display = "none";
        grind.children[1].src = "images/system/air.png";
    }
}
